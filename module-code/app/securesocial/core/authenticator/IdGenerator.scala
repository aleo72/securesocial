...
object IdGenerator {
   ...
   */
  class Default(val configuration: Configuration) extends IdGenerator {
    ...
    val IdSizeInBytes = configuration.getOptional[Int](IdLengthKey).getOrElse(DefaultSizeInBytes)
