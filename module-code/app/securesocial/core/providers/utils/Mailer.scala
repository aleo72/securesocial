...
object Mailer {
   ...
   */
  class Default(mailTemplates: MailTemplates, mailerClient: MailerClient, configuration: Configuration, system: ActorSystem)(implicit executor: ExecutionContext) extends Mailer {
